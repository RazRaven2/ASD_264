...
class Die:
    """A six-sided die with roll and display behavior."""

    def roll(self):
        """Return a random roll between 1 and 6."""
        return random.randint(1, 6)

    def print_face(self, roll):
        """Print an ASCII representation of the provided die value."""
        die = [
            " ------- ",
            "|       |",
            "|       |",
